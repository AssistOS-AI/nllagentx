...
const definitions = [
  ...
  ["nll-sdk", ["DS-002", "DS039", "DS043", "DS044"], ["SDK_CATALOG.md", "ONTOLOGY_CATALOG.md", "RESPONSE_CIRCUIT_CATALOG.md"], ["catalog sdk", "sdk check", "sdk usage", "ontology build", "ontology check", "test framework --level fast"], [], ["framework/sdk"]],
  ["nll-runtime", ["DS-003", "DS043", "DS044"], ["SDK_CATALOG.md", "CIRCUIT_CATALOG.md", "RESPONSE_CIRCUIT_CATALOG.md", "DIAGNOSTICS.md"], ["sdk check", "ontology check", "longtext execute", "circuit plan", "circuit run", "circuit abstract", "circuit symbolic", "trace slice", "test framework"], ["nll-sdk"], ["framework/runtime", "framework/sdk/analysis"]],
  ["nll-intent", ["DS-004", "DS035", "DS041", "DS042", "DS043", "DS044"], ["SOURCE_OUTLINE.md", "ONTOLOGY_CATALOG.md", "CIRCUIT_CATALOG.md", "RESPONSE_CIRCUIT_CATALOG.md", "PROFILE_RESOLUTION.md"], ["source outline", "source search", "catalog ontology", "catalog circuit", "profile resolve", "intent infer-signals", "intent check", "intent explain", "plan show"], ["nll-ontology"], ["task/intent", "task/profiles"]],
  ...
  ["nll-circuit", ["DS-003", "DS-000", "DS-007-DS-019", "DS005", "DS041", "DS042", "DS043", "DS044"], ["CIRCUIT_CATALOG.md", "RESPONSE_CIRCUIT_CATALOG.md", "ONTOLOGY_CATALOG.md", "SDK_CATALOG.md", "DIAGNOSTICS.md"], ["catalog circuit", "catalog ontology", "sdk usage", "longtext query", "circuit check", "circuit plan", "circuit run", "circuit abstract", "circuit symbolic", "trace slice", "cnl roundtrip", "test task"], ["nll-runtime", "nll-ontology"], ["framework/packs", "agent/circuits", "agent/cnl", "task/circuits", "task/cnl"]],
