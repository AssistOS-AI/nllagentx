---
id: DS031
title: Evaluation Skill Contract
status: implemented
owner: nll-evaluate
summary: Builds isolated suites, coding-agent runs, semantic metrics, and retained reports.
---

# DS031 — Evaluation Skill Contract

## Introduction

This specification makes the `nll-evaluate` coding workflow part of the official contract. The executable companion is `nll-skills/nll-evaluate/workflow.mjs`.
