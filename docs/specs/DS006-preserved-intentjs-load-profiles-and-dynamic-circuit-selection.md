---
id: DS006
title: Preserved IntentJS, Load Profiles and Dynamic Circuit Selection
status: normative-implemented
owner: nllAgent architecture
summary: Preserves DS-004_IntentJS_Load_Profiles_and_Dynamic_Circuit_Selection.md verbatim and records additive implementation alignment.
---

# DS006 — Preserved IntentJS, Load Profiles and Dynamic Circuit Selection
...
The following source specification is included verbatim from `design-specifications/DS-004_IntentJS_Load_Profiles_and_Dynamic_Circuit_Selection.md`.

<!-- ORIGINAL SPECIFICATION START: DS-004_IntentJS_Load_Profiles_and_Dynamic_Circuit_Selection.md -->
...
<!-- ORIGINAL SPECIFICATION END: DS-004_IntentJS_Load_Profiles_and_Dynamic_Circuit_Selection.md -->
