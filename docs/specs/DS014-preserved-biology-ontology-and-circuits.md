---
id: DS014
title: Preserved Biology Ontology and Circuits
status: normative-implemented
owner: nllAgent architecture
summary: Preserves DS-012_Biology_Ontology_and_Circuits.md verbatim and records additive implementation alignment.
---

# DS014 — Preserved Biology Ontology and Circuits
...
The following source specification is included verbatim from `design-specifications/DS-012_Biology_Ontology_and_Circuits.md`.

<!-- ORIGINAL SPECIFICATION START: DS-012_Biology_Ontology_and_Circuits.md -->
