---
id: DS003
title: Preserved Workspaces, CLI, Coding Agents and the nll-* Skill System
status: normative-implemented
owner: nllAgent architecture
summary: Preserves DS-001_Workspaces_CLI_Coding_Agents_and_Skills.md verbatim and records additive implementation alignment.
---

# DS003 — Preserved Workspaces, CLI, Coding Agents and the nll-* Skill System
...
The following source specification is included verbatim from `design-specifications/DS-001_Workspaces_CLI_Coding_Agents_and_Skills.md`.

<!-- ORIGINAL SPECIFICATION START: DS-001_Workspaces_CLI_Coding_Agents_and_Skills.md -->
...
<!-- ORIGINAL SPECIFICATION END: DS-001_Workspaces_CLI_Coding_Agents_and_Skills.md -->
