...
- `runs/run-ptc_UFmk4dJhwhiF/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-ptc_UFmk4dJhwhiF/skills/nll-sdk/workflow.mjs`)
...
4. Context catalogs under `runs/run-ptc_UFmk4dJhwhiF/context`.
