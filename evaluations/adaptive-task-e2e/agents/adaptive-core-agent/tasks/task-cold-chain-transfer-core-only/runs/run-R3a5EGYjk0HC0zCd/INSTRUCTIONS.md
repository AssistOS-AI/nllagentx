...
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-test/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-test/workflow.mjs`)
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-sdk/workflow.mjs`)
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-ontology/workflow.mjs`)
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-intent/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-intent/workflow.mjs`)
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-longtext/workflow.mjs`)
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-runtime/workflow.mjs`)
- `runs/run-R3a5EGYjk0HC0zCd/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-R3a5EGYjk0HC0zCd/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-R3a5EGYjk0HC0zCd/context`.
