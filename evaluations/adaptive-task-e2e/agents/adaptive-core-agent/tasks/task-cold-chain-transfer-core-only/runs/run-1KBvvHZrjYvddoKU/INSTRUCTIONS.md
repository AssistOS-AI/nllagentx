...
- `runs/run-1KBvvHZrjYvddoKU/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-1KBvvHZrjYvddoKU/skills/nll-sdk/workflow.mjs`)
- `runs/run-1KBvvHZrjYvddoKU/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-1KBvvHZrjYvddoKU/skills/nll-ontology/workflow.mjs`)
...
4. Context catalogs under `runs/run-1KBvvHZrjYvddoKU/context`.
