...
- `runs/run-4hvH9gHbGn60fQPD/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-4hvH9gHbGn60fQPD/skills/nll-sdk/workflow.mjs`)
- `runs/run-4hvH9gHbGn60fQPD/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-4hvH9gHbGn60fQPD/skills/nll-runtime/workflow.mjs`)
- `runs/run-4hvH9gHbGn60fQPD/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-4hvH9gHbGn60fQPD/skills/nll-ontology/workflow.mjs`)
- `runs/run-4hvH9gHbGn60fQPD/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-4hvH9gHbGn60fQPD/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-4hvH9gHbGn60fQPD/context`, including the resolved semantic and response-circuit catalogs.
