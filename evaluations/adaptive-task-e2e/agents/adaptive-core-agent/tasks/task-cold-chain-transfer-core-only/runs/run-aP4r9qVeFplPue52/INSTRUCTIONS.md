...
- `runs/run-aP4r9qVeFplPue52/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-aP4r9qVeFplPue52/skills/nll-sdk/workflow.mjs`)
- `runs/run-aP4r9qVeFplPue52/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-aP4r9qVeFplPue52/skills/nll-ontology/workflow.mjs`)
...
4. Context catalogs under `runs/run-aP4r9qVeFplPue52/context`, including the resolved semantic and response-circuit catalogs.
