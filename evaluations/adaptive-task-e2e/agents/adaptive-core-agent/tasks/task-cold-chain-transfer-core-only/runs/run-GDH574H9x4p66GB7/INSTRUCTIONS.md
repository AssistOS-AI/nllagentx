...
- `runs/run-GDH574H9x4p66GB7/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-GDH574H9x4p66GB7/skills/nll-sdk/workflow.mjs`)
- `runs/run-GDH574H9x4p66GB7/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-GDH574H9x4p66GB7/skills/nll-ontology/workflow.mjs`)
- `runs/run-GDH574H9x4p66GB7/skills/nll-intent/SKILL.md` (executable contract: `runs/run-GDH574H9x4p66GB7/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-GDH574H9x4p66GB7/context`.
