...
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-test/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-test/workflow.mjs`)
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-sdk/workflow.mjs`)
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-ontology/workflow.mjs`)
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-intent/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-intent/workflow.mjs`)
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-longtext/workflow.mjs`)
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-runtime/workflow.mjs`)
- `runs/run-_5VvSq_gCXQM3nHK/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-_5VvSq_gCXQM3nHK/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-_5VvSq_gCXQM3nHK/context`, including the resolved semantic and response-circuit catalogs.
