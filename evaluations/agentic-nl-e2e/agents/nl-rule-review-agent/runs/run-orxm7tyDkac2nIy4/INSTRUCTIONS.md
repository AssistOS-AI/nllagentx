...
- `runs/run-orxm7tyDkac2nIy4/skills/nll-architect/SKILL.md` (executable contract: `runs/run-orxm7tyDkac2nIy4/skills/nll-architect/workflow.mjs`)
...
4. Context catalogs under `runs/run-orxm7tyDkac2nIy4/context`.
