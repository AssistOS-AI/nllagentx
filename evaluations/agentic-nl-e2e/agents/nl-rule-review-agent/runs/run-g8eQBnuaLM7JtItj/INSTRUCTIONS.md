...
- `runs/run-g8eQBnuaLM7JtItj/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-g8eQBnuaLM7JtItj/skills/nll-sdk/workflow.mjs`)
- `runs/run-g8eQBnuaLM7JtItj/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-g8eQBnuaLM7JtItj/skills/nll-runtime/workflow.mjs`)
- `runs/run-g8eQBnuaLM7JtItj/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-g8eQBnuaLM7JtItj/skills/nll-ontology/workflow.mjs`)
- `runs/run-g8eQBnuaLM7JtItj/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-g8eQBnuaLM7JtItj/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-g8eQBnuaLM7JtItj/context`.
