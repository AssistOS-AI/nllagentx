...
- `runs/run-CsuE4wAaA0foWDNx/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-CsuE4wAaA0foWDNx/skills/nll-sdk/workflow.mjs`)
- `runs/run-CsuE4wAaA0foWDNx/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-CsuE4wAaA0foWDNx/skills/nll-runtime/workflow.mjs`)
- `runs/run-CsuE4wAaA0foWDNx/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-CsuE4wAaA0foWDNx/skills/nll-ontology/workflow.mjs`)
- `runs/run-CsuE4wAaA0foWDNx/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-CsuE4wAaA0foWDNx/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-CsuE4wAaA0foWDNx/context`, including the resolved semantic and response-circuit catalogs.
