...
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-test/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-test/workflow.mjs`)
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-sdk/workflow.mjs`)
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-ontology/workflow.mjs`)
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-intent/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-intent/workflow.mjs`)
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-longtext/workflow.mjs`)
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-runtime/workflow.mjs`)
- `runs/run-6MSznQXBBR2OIX_1/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-6MSznQXBBR2OIX_1/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-6MSznQXBBR2OIX_1/context`, including the resolved semantic and response-circuit catalogs.
