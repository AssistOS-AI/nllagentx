...
- `runs/run-81lSFJQMF7QzTkxM/skills/nll-architect/SKILL.md` (executable contract: `runs/run-81lSFJQMF7QzTkxM/skills/nll-architect/workflow.mjs`)
...
4. Context catalogs under `runs/run-81lSFJQMF7QzTkxM/context`, including the resolved semantic and response-circuit catalogs.
