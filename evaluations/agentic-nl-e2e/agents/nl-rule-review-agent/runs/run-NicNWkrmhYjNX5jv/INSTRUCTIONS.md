...
Goal: Read source/agent-brief.md and complete the circuit authoring phase for this evaluation agent. Edit canonical agent files directly, use the installed skill and live SDK catalogs, create the required executable .mjs artifacts and focused tests, and do not replace semantics with JSON.
...
- `runs/run-NicNWkrmhYjNX5jv/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-NicNWkrmhYjNX5jv/skills/nll-sdk/workflow.mjs`)
- `runs/run-NicNWkrmhYjNX5jv/skills/nll-runtime/SKILL.md` (executable contract: `runs/run-NicNWkrmhYjNX5jv/skills/nll-runtime/workflow.mjs`)
- `runs/run-NicNWkrmhYjNX5jv/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-NicNWkrmhYjNX5jv/skills/nll-ontology/workflow.mjs`)
- `runs/run-NicNWkrmhYjNX5jv/skills/nll-circuit/SKILL.md` (executable contract: `runs/run-NicNWkrmhYjNX5jv/skills/nll-circuit/workflow.mjs`)
...
4. Context catalogs under `runs/run-NicNWkrmhYjNX5jv/context`.
