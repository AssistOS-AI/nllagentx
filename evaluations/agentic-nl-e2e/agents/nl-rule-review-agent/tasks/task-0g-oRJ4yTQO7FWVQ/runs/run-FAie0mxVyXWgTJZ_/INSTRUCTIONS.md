...
Goal: Read task.mjs, the registered source files, and the existing agent ontology/circuit catalog. Complete the intent authoring phase for case unsupported-safety-conclusion. Preserve the task instruction exactly, create executable source-grounded semantic code and focused tests, and leave unsupported meanings explicit rather than inventing evidence.
...
- `runs/run-FAie0mxVyXWgTJZ_/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-FAie0mxVyXWgTJZ_/skills/nll-sdk/workflow.mjs`)
- `runs/run-FAie0mxVyXWgTJZ_/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-FAie0mxVyXWgTJZ_/skills/nll-ontology/workflow.mjs`)
- `runs/run-FAie0mxVyXWgTJZ_/skills/nll-intent/SKILL.md` (executable contract: `runs/run-FAie0mxVyXWgTJZ_/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-FAie0mxVyXWgTJZ_/context`.
