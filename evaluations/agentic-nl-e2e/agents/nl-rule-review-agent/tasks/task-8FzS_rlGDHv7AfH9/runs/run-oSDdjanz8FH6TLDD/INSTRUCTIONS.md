...
- `runs/run-oSDdjanz8FH6TLDD/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-oSDdjanz8FH6TLDD/skills/nll-sdk/workflow.mjs`)
- `runs/run-oSDdjanz8FH6TLDD/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-oSDdjanz8FH6TLDD/skills/nll-ontology/workflow.mjs`)
- `runs/run-oSDdjanz8FH6TLDD/skills/nll-intent/SKILL.md` (executable contract: `runs/run-oSDdjanz8FH6TLDD/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-oSDdjanz8FH6TLDD/context`.
