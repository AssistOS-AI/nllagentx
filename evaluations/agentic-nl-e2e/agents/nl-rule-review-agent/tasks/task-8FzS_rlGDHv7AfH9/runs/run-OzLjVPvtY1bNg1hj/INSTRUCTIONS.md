...
Goal: Read task.mjs, the registered source files, and the existing agent ontology/circuit catalog. Complete the longtext authoring phase for case contradictory-rules. Preserve the task instruction exactly, create executable source-grounded semantic code and focused tests, and leave unsupported meanings explicit rather than inventing evidence.

Project root: /home/salboaie/work/nllagentx
Canonical working directory: /home/salboaie/work/nllagentx/evaluations/agentic-nl-e2e/agents/nl-rule-review-agent/tasks/task-8FzS_rlGDHv7AfH9
...
- `runs/run-OzLjVPvtY1bNg1hj/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-OzLjVPvtY1bNg1hj/skills/nll-sdk/workflow.mjs`)
- `runs/run-OzLjVPvtY1bNg1hj/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-OzLjVPvtY1bNg1hj/skills/nll-ontology/workflow.mjs`)
- `runs/run-OzLjVPvtY1bNg1hj/skills/nll-intent/SKILL.md` (executable contract: `runs/run-OzLjVPvtY1bNg1hj/skills/nll-intent/workflow.mjs`)
- `runs/run-OzLjVPvtY1bNg1hj/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-OzLjVPvtY1bNg1hj/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-OzLjVPvtY1bNg1hj/context`.
