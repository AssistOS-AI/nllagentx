...
- `runs/run-3HmKYR0s8vQehol5/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-3HmKYR0s8vQehol5/skills/nll-sdk/workflow.mjs`)
- `runs/run-3HmKYR0s8vQehol5/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-3HmKYR0s8vQehol5/skills/nll-ontology/workflow.mjs`)
- `runs/run-3HmKYR0s8vQehol5/skills/nll-intent/SKILL.md` (executable contract: `runs/run-3HmKYR0s8vQehol5/skills/nll-intent/workflow.mjs`)
- `runs/run-3HmKYR0s8vQehol5/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-3HmKYR0s8vQehol5/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-3HmKYR0s8vQehol5/context`.
