...
test("IntentJS requests source-grounded exception review and Markdown CNL", () => {
...
test("the selected concern resolves only to the reusable exception-review circuit", () => {
