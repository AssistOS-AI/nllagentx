...
- `runs/run-cww5N-NOzSzZRzhr/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-cww5N-NOzSzZRzhr/skills/nll-sdk/workflow.mjs`)
- `runs/run-cww5N-NOzSzZRzhr/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-cww5N-NOzSzZRzhr/skills/nll-ontology/workflow.mjs`)
- `runs/run-cww5N-NOzSzZRzhr/skills/nll-intent/SKILL.md` (executable contract: `runs/run-cww5N-NOzSzZRzhr/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-cww5N-NOzSzZRzhr/context`, including the resolved semantic and response-circuit catalogs.
