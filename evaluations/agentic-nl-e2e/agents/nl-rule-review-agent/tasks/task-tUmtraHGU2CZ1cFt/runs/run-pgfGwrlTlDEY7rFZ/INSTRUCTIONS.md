...
Goal: Read task.mjs, the registered source files, and the existing agent ontology, semantic-circuit and response-circuit catalogs. Complete the longtext authoring phase for case missing-exception-justification. Preserve the task instruction exactly, create executable source-grounded semantic code and focused tests, and leave unsupported meanings explicit rather than inventing evidence. IntentJS must request markdownCnl() and declare an appropriate .present(...) policy; ground the decisive source passages needed for a concise qualitative response.

Project root: /home/salboaie/work/nllagentx
Canonical working directory: /home/salboaie/work/nllagentx/evaluations/agentic-nl-e2e/agents/nl-rule-review-agent/tasks/task-tUmtraHGU2CZ1cFt
...
- `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-sdk/workflow.mjs`)
- `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-ontology/workflow.mjs`)
- `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-intent/SKILL.md` (executable contract: `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-intent/workflow.mjs`)
- `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-pgfGwrlTlDEY7rFZ/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-pgfGwrlTlDEY7rFZ/context`, including the resolved semantic and response-circuit catalogs.
