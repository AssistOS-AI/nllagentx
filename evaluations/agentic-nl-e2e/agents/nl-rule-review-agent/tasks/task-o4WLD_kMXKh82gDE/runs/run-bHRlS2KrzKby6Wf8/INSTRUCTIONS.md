...
Canonical working directory: /home/salboaie/work/nllagentx/evaluations/agentic-nl-e2e/agents/nl-rule-review-agent/tasks/task-o4WLD_kMXKh82gDE
...
- `runs/run-bHRlS2KrzKby6Wf8/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-bHRlS2KrzKby6Wf8/skills/nll-sdk/workflow.mjs`)
- `runs/run-bHRlS2KrzKby6Wf8/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-bHRlS2KrzKby6Wf8/skills/nll-ontology/workflow.mjs`)
- `runs/run-bHRlS2KrzKby6Wf8/skills/nll-intent/SKILL.md` (executable contract: `runs/run-bHRlS2KrzKby6Wf8/skills/nll-intent/workflow.mjs`)
- `runs/run-bHRlS2KrzKby6Wf8/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-bHRlS2KrzKby6Wf8/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-bHRlS2KrzKby6Wf8/context`.
