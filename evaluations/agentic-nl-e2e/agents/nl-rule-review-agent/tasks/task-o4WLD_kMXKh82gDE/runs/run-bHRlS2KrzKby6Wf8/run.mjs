...
export default codingRun("run-bHRlS2KrzKby6Wf8")
  .using("codex")
  ...
  .objective("Read task.mjs, the registered source files, and the existing agent ontology/circuit catalog. Complete the longtext authoring phase for case generate-compliant-procedure. Preserve the task instruction exactly, create executable source-grounded semantic code and focused tests, and leave unsupported meanings explicit rather than inventing evidence.")
