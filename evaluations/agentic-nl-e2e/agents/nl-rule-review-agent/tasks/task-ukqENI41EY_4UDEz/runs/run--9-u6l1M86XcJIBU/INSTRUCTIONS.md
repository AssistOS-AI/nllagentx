...
- `runs/run--9-u6l1M86XcJIBU/skills/nll-sdk/SKILL.md` (executable contract: `runs/run--9-u6l1M86XcJIBU/skills/nll-sdk/workflow.mjs`)
- `runs/run--9-u6l1M86XcJIBU/skills/nll-ontology/SKILL.md` (executable contract: `runs/run--9-u6l1M86XcJIBU/skills/nll-ontology/workflow.mjs`)
- `runs/run--9-u6l1M86XcJIBU/skills/nll-intent/SKILL.md` (executable contract: `runs/run--9-u6l1M86XcJIBU/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run--9-u6l1M86XcJIBU/context`, including the resolved semantic and response-circuit catalogs.
