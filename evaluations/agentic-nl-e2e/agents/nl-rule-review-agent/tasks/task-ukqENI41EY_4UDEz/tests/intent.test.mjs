...
test("IntentJS requests source-grounded controlled procedure generation and Markdown CNL", () => {
  ...
  assert.deepEqual(values(intentModel.outputs), [
    "findings",
    "cnl-observations",
    "composition-plan",
    "markdown-cnl"
...
test("IntentJS declares the procedural qualitative response policy", () => {
