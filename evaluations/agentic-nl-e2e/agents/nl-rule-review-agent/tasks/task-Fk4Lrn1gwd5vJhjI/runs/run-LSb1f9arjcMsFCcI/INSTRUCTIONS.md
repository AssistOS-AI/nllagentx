...
- `runs/run-LSb1f9arjcMsFCcI/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-LSb1f9arjcMsFCcI/skills/nll-sdk/workflow.mjs`)
- `runs/run-LSb1f9arjcMsFCcI/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-LSb1f9arjcMsFCcI/skills/nll-ontology/workflow.mjs`)
- `runs/run-LSb1f9arjcMsFCcI/skills/nll-intent/SKILL.md` (executable contract: `runs/run-LSb1f9arjcMsFCcI/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-LSb1f9arjcMsFCcI/context`, including the resolved semantic and response-circuit catalogs.
