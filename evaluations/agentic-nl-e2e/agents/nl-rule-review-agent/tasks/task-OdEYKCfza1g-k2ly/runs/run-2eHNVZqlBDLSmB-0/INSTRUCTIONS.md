...
Goal: Read task.mjs, the registered source files, and the existing agent ontology/circuit catalog. Complete the longtext authoring phase for case generate-compliant-procedure. Preserve the task instruction exactly, create executable source-grounded semantic code and focused tests, and leave unsupported meanings explicit rather than inventing evidence.

Project root: /home/salboaie/work/nllagentx
Canonical working directory: /home/salboaie/work/nllagentx/evaluations/agentic-nl-e2e/agents/nl-rule-review-agent/tasks/task-OdEYKCfza1g-k2ly
...
- `runs/run-2eHNVZqlBDLSmB-0/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-2eHNVZqlBDLSmB-0/skills/nll-sdk/workflow.mjs`)
- `runs/run-2eHNVZqlBDLSmB-0/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-2eHNVZqlBDLSmB-0/skills/nll-ontology/workflow.mjs`)
- `runs/run-2eHNVZqlBDLSmB-0/skills/nll-intent/SKILL.md` (executable contract: `runs/run-2eHNVZqlBDLSmB-0/skills/nll-intent/workflow.mjs`)
- `runs/run-2eHNVZqlBDLSmB-0/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-2eHNVZqlBDLSmB-0/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-2eHNVZqlBDLSmB-0/context`.
