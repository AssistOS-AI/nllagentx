...
- `runs/run-67GxvPT3pqjztK8I/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-67GxvPT3pqjztK8I/skills/nll-sdk/workflow.mjs`)
- `runs/run-67GxvPT3pqjztK8I/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-67GxvPT3pqjztK8I/skills/nll-ontology/workflow.mjs`)
- `runs/run-67GxvPT3pqjztK8I/skills/nll-intent/SKILL.md` (executable contract: `runs/run-67GxvPT3pqjztK8I/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-67GxvPT3pqjztK8I/context`.
