...
- `runs/run-p23q4m1xJFYrv5TI/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-p23q4m1xJFYrv5TI/skills/nll-sdk/workflow.mjs`)
- `runs/run-p23q4m1xJFYrv5TI/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-p23q4m1xJFYrv5TI/skills/nll-ontology/workflow.mjs`)
- `runs/run-p23q4m1xJFYrv5TI/skills/nll-intent/SKILL.md` (executable contract: `runs/run-p23q4m1xJFYrv5TI/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-p23q4m1xJFYrv5TI/context`.
