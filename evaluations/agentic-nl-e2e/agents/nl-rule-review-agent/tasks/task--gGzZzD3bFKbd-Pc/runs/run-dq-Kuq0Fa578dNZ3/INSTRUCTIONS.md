...
- `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-sdk/workflow.mjs`)
- `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-ontology/workflow.mjs`)
- `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-intent/SKILL.md` (executable contract: `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-intent/workflow.mjs`)
- `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-dq-Kuq0Fa578dNZ3/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-dq-Kuq0Fa578dNZ3/context`, including the resolved semantic and response-circuit catalogs.
