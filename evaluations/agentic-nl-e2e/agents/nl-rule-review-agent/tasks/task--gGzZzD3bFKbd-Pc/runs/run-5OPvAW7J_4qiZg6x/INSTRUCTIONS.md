...
- `runs/run-5OPvAW7J_4qiZg6x/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-5OPvAW7J_4qiZg6x/skills/nll-sdk/workflow.mjs`)
- `runs/run-5OPvAW7J_4qiZg6x/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-5OPvAW7J_4qiZg6x/skills/nll-ontology/workflow.mjs`)
- `runs/run-5OPvAW7J_4qiZg6x/skills/nll-intent/SKILL.md` (executable contract: `runs/run-5OPvAW7J_4qiZg6x/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-5OPvAW7J_4qiZg6x/context`, including the resolved semantic and response-circuit catalogs.
