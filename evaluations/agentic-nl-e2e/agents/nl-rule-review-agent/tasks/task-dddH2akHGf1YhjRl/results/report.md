...
Task: `task-dddH2akHGf1YhjRl`. Profile: `minimal-core`.

- Executed semantic circuits: 5
- Selected response circuits: 3
- Public CNL findings: 0
- Raw findings, including internal and non-applicable results: 5
- Generated CNL frames: 0
- Auxiliary assurance passes: 0
