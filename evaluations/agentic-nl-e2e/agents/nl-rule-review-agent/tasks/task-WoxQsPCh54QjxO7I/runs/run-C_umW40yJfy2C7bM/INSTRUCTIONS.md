...
- `runs/run-C_umW40yJfy2C7bM/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-C_umW40yJfy2C7bM/skills/nll-sdk/workflow.mjs`)
- `runs/run-C_umW40yJfy2C7bM/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-C_umW40yJfy2C7bM/skills/nll-ontology/workflow.mjs`)
- `runs/run-C_umW40yJfy2C7bM/skills/nll-intent/SKILL.md` (executable contract: `runs/run-C_umW40yJfy2C7bM/skills/nll-intent/workflow.mjs`)
...
4. Context catalogs under `runs/run-C_umW40yJfy2C7bM/context`.
