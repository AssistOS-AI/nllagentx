...
Goal: Read task.mjs, the registered source files, and the existing agent ontology/circuit catalog. Complete the longtext authoring phase for case missing-exception-justification. Preserve the task instruction exactly, create executable source-grounded semantic code and focused tests, and leave unsupported meanings explicit rather than inventing evidence.

Project root: /home/salboaie/work/nllagentx
Canonical working directory: /home/salboaie/work/nllagentx/evaluations/agentic-nl-e2e/agents/nl-rule-review-agent/tasks/task-WoxQsPCh54QjxO7I
...
- `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-sdk/workflow.mjs`)
- `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-ontology/workflow.mjs`)
- `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-intent/SKILL.md` (executable contract: `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-intent/workflow.mjs`)
- `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-EmL0oEyeCAMfnZ2g/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-EmL0oEyeCAMfnZ2g/context`.
