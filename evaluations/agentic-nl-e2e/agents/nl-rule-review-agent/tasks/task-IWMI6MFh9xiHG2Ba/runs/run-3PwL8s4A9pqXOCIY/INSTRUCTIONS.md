...
Canonical working directory: /home/salboaie/work/nllagentx/evaluations/agentic-nl-e2e/agents/nl-rule-review-agent/tasks/task-IWMI6MFh9xiHG2Ba
...
- `runs/run-3PwL8s4A9pqXOCIY/skills/nll-sdk/SKILL.md` (executable contract: `runs/run-3PwL8s4A9pqXOCIY/skills/nll-sdk/workflow.mjs`)
- `runs/run-3PwL8s4A9pqXOCIY/skills/nll-ontology/SKILL.md` (executable contract: `runs/run-3PwL8s4A9pqXOCIY/skills/nll-ontology/workflow.mjs`)
- `runs/run-3PwL8s4A9pqXOCIY/skills/nll-intent/SKILL.md` (executable contract: `runs/run-3PwL8s4A9pqXOCIY/skills/nll-intent/workflow.mjs`)
- `runs/run-3PwL8s4A9pqXOCIY/skills/nll-longtext/SKILL.md` (executable contract: `runs/run-3PwL8s4A9pqXOCIY/skills/nll-longtext/workflow.mjs`)
...
4. Context catalogs under `runs/run-3PwL8s4A9pqXOCIY/context`.
